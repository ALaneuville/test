...
public class ConfirmSponsorsKeyValuesInRD_NativeAdsArticlePage extends Driver {
	//Initialize object using page factory method 
	ConfigFileReader configFileReader;
	public  Logger APPLICATION_LOGS = Logger.getLogger("AppLogger");

	@Test
	public void confirm_Sponsors_ValueIn_RD_NativeAdsArticlePage() throws Exception{
		...
		if(environment.equalsIgnoreCase("production")){
			...
			//Test Data
			String url=Constant.RD_NativeAdsArticlePage+"?googfc";
			...
			APPLICATION_LOGS.debug("Not required to verify Sponsors_ValueIn_RD_NativeAdsArticlePage for staging environment ");
			System.out.println("Not required to verify Sponsors_ValueIn_RD_NativeAdsArticlePage for staging environment ");
		}
	}
}
