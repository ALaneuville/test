...
public class ConfirmKeyValuesInBHC_RecipeDetail extends Driver {
	//Initialize object using page factory method 
		ConfigFileReader configFileReader;
		public  Logger APPLICATION_LOGS = Logger.getLogger("AppLogger");
		
	      //Test Data
	      String url=Constant.BHC_RecipeDetailPage+"?googfc";
	...
	@Test 
	public void confirmPosValueIn_BHC_RecipeDetail() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmContentIDValueIn_BHC_RecipeDetail() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmCategoryValueIn_BHC_RecipeDetail() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmTopicValueIn_BHC_RecipeDetail() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmKeywordValueIn_BHC_RecipeDetail() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmURLValueIn_BHC_RecipeDetail() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmThemeValueIn_BHC_RecipeDetail() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmPtValueIn_BHC_RecipeDetail() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmAuthorValueIn_BHC_RecipeDetail() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmTax0ValueIn_BHC_RecipeDetail() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmTax1ValueIn_BHC_RecipeDetail() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmTax2ValueIn_BHC_RecipeDetail() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmTax3ValueIn_BHC_RecipeDetail() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmTfValueIn_BHC_RecipeDetail() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmLocationValueIn_BHC_RecipeDetail() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmRandomValueIn_BHC_RecipeDetail() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmGS_CATValueIn_BHC_RecipeDetail() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
