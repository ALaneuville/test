...
public class ConfirmKeyValuesInTOH_SlideShowPage extends Driver {
	//Initialize object using page factory method 
	ConfigFileReader configFileReader;
	public  Logger APPLICATION_LOGS = Logger.getLogger("AppLogger");

	//Test Data
	String url=Constant.TOH_SlideshowPage+"?googfc";
	...
	@Test 
	public void confirmPos_ValueIn_TOH_SlideShow() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmContentID_ValueIn_TOH_SlideShow() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmCategory_ValueIn_TOH_SlideShow() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmTopic_ValueIn_TOH_SlideShow() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmKeyword_ValueIn_TOH_SlideShow() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmURL_ValueIn_TOH_SlideShow() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmTheme_ValueIn_TOH_SlideShow() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmPt_ValueIn_TOH_SlideShow() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmAuthor_ValueIn_TOH_SlideShow() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmTax0_ValueIn_TOH_SlideShow() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmTax1_ValueIn_TOH_SlideShow() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmTax2_ValueIn_TOH_SlideShow() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmTax3_ValueIn_TOH_SlideShow() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmTf_ValueIn_TOH_SlideShow() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmLocation_ValueIn_TOH_SlideShow() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmRandom_ValueIn_TOH_SlideShow() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmBudget_ValueIn_TOH_SlideShow() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmCuisine_ValueIn_TOH_SlideShow() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmCourse_ValueIn_TOH_SlideShow() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmWinningRecipes_ValueIn_TOH_SlideShow() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmKids_ValueIn_TOH_SlideShow() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmHolidays_ValueIn_TOH_SlideShow() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmIngredients_ValueIn_TOH_SlideShow() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmHealthyEating_ValueIn_TOH_SlideShow() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmPartnerRecipes_ValueIn_TOH_SlideShow() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmCookingStyle_ValueIn_TOH_SlideShow() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmCampaignID_ValueIn_TOH_SlideShow() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmSponsor_ValueIn_TOH_SlideShow() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmGS_CAT_ValueIn_TOH_SlideShow() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test 
	public void confirmKUID_ValueIn_TOH_SlideShow() throws Exception{
		//Object Initialization
		GlobalFunctions globalPage=PageFactory.initElements(driver, GlobalFunctions.class);
