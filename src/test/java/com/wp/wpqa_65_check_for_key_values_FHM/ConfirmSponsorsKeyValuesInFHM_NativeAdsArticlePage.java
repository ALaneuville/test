...
public class ConfirmSponsorsKeyValuesInFHM_NativeAdsArticlePage extends Driver {
	///Initialize object using page factory method 
	ConfigFileReader configFileReader;
	public  Logger APPLICATION_LOGS = Logger.getLogger("AppLogger");

	@Test
	public void confirm_Sponsors_ValueIn_FHM_NativeAdsArticlePage() throws Exception{
		...
		if(environment.equalsIgnoreCase("production")){
			...
			//Test Data
			String url=Constant.FHM_NativeAdsArticlePage+"?googfc";
			...
			APPLICATION_LOGS.debug("Not required to verify Sponsors_ValueIn_FHM_NativeAdsArticlePage for staging environment ");
			System.out.println("Not required to verify Sponsors_ValueIn_FHM_NativeAdsArticlePage for staging environment ");
		}
	}
}