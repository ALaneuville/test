...
public class VerifyGlobalVariablesPartnerList_CPT_SlideshowPage extends Driver {
	//Initialize object using page factory method 
	ConfigFileReader configFileReader;
	public  Logger APPLICATION_LOGS = Logger.getLogger("AppLogger");

	//Test Data
	String url=Constant.CPT_SlideshowPage;
	...
	@Test
	public void Verify_Nativo_Global_Variable_PartnerList_CPT_SlideshowPage() throws IOException{
		//Object Initialization
	...
	@Test
	public void Verify_Taboola_Global_Variable_PartnerList_CPT_SlideshowPage() throws IOException{
		//Object Initialization
		GlobalFunctions gfPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test
	public void Verify_BounceExchange_Global_Variable_PartnerList_CPT_SlideshowPage() throws IOException{
		//Object Initialization
		GlobalFunctions gfPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test
	public void Verify_JWPlayer_Global_Variable_PartnerList_CPT_SlideshowPage() throws IOException{
		//Object Initialization
		GlobalFunctions gfPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test
	public void Verify_JWPlayer_Ad_Partners_Spotx_EMX_Telaria_CPT_SlideshowPage() throws IOException{
		//Object Initialization
		GlobalFunctions gfPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test
	public void Verify_Krux_Global_Variable_PartnerList_CPT_SlideshowPage() throws IOException{
		//Object Initialization
		GlobalFunctions gfPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test
	public void Verify_AdobeDTM_Global_Variable_PartnerList_CPT_SlideshowPage() throws IOException{
		//Object Initialization
		GlobalFunctions gfPage=PageFactory.initElements(driver, GlobalFunctions.class);
	...
	@Test
	public void Verify_Appnexus_Global_Variable_PartnerList_CPT_SlideshowPage() throws IOException{
		//Object Initialization
		GlobalFunctions gfPage=PageFactory.initElements(driver, GlobalFunctions.class);
