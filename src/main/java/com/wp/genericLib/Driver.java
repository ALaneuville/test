...
public class Driver {
	...
	public void initialize() throws Exception{
		...
		//Check if parameter passed from property file is 'chrome'
			...
			String chromeDriverPath = Paths.get(driverDir, "chromedriver" + (useExe ? ".exe" : "")).toString();
	...
	public void TeardownTest() throws Exception
	{
		...
		java.lang.Runtime.getRuntime().exec("TASKKILL /IM chrome.exe /F");
		//java.lang.Runtime.getRuntime().exec("TASKKILL /IM chromedriver.exe /F");
	}
